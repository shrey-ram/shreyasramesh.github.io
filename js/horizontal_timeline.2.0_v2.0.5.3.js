...
;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'horizontalTimeline',
		defaults = {
			...
			scrollLeft_iconClass: "fa-facebook",
			scrollRight_iconClass: "fa-facebook",
			prev_iconClass: "fa-facebook",
			next_iconClass: "fa-facebook",
			...
			iconClass: {
				"base": "fa fa-2x", // Space separated class names
